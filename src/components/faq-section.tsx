  ...
  const faqs = [
    {
      ...
      answer:
        "Нет, AstraLogic работает прямо в браузере. Просто зайдите на сайт, зарегистрируйтесь и начните пользоваться — никаких установок и настроек.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "AstraLogic использует одну из лучших языковых моделей. Для творческих задач и работы с текстом точность очень высокая. Для фактических данных рекомендуем проверять информацию из дополнительных источников.",
    },
    {
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto font-space-mono">
            Ответы на популярные вопросы о платформе AstraLogic и работе с нейросетью.
          </p>
        </div>
